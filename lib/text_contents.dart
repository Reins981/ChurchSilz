...
const String mailRecipient = "reins981@gmail.com";
...
String getTextContentGerman(String textContentType) {
  ...
  Map<String, String> textContents = {
    ...
    "prayerMessageHeader": "Gebete und Fürbitten",
    "prayerMessageHeadline": "Ihre Gebetsanliegen und Fürbitten",
    "prayerInfoMessage": "Hier können Sie Ihre persönlichen Gebetsanliegen und Fürbitten formulieren",
    "prayerPreferredLanguage": "Bevorzugte Sprache",
    "prayerFirstName": "Vorname",
    "prayerLastName": "Nachname (Optional)",
    "prayerEmail": "Email Adresse",
    "prayerSendText": "Senden",
    "prayerSendError": "Unvollständige Eingabe",
    "prayerDetailsPart1": "Gebetsanliegen max (",
    "prayerDetailsPart2": " ) Zeichen",
    "prayerRequestSuccess": "Vielen Dank! Gebetsanfrage erfolgreich versendet",
    "prayerRequestError": "Sendefehler: "
...
String getTextContentEnglish(String textContentType) {
  ...
  Map<String, String> textContents = {
    ...
    "dashboardMessageHeader": "Main Menu",
    "interactiveMapMessage": "Interactive Card",
    "virtualChurchDashboard": "Virtual Church",
    "churchHistoryDashboard": "History",
    "actualNewsDashboard": "News",
    "donationDashboard": "Donation",
    "prayerDashboard": "Prayer",
    ...
    "prayerMessageHeader": "Prayer Requests",
    "prayerMessageHeadline": "Your prayer requests and intercessions",
    "prayerInfoMessage": "Here you can formulate your personal prayer requests and intercessions",
    "prayerPreferredLanguage": "Preferred Language",
    "prayerFirstName": "First Name",
    "prayerLastName": "Last name (Optional)",
    "prayerEmail": "Email Address",
    "prayerSendText": "Send",
    "prayerSendError": "Incomplete Input",
    "prayerDetailsPart1": "Prayer request max (",
    "prayerDetailsPart2": " ) characters",
    "prayerRequestSuccess": "Thank you! Prayer request sent successfully",
    "prayerRequestError": "Error sending prayer request: "
  };
